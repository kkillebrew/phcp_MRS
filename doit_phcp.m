...
% for our data, we want to select metab_RES -- resolved data, not summed,
% so we can do both frequency and phase correction
...
fwater = processing_spec(fwater,parw);
...
processing_LCmodel('steam',pp.root_dir)           %and select the dir in which raw files are written
